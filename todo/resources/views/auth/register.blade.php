        ...
        <div class="row justify-content-center">
            <div class="col-md-6 mt-5 pt-5">
                <form method="post" action="{{route('register')}}">
                    ...
                    <h1 class="h3 mb-3 fw-normal">Регистрация в ToDoList</h1>

                    <div class="form-floating mb-2">
                        <input type="text" name="name" class="form-control" id="floatingInputName" placeholder="Иван Иванов">
